...
Below are guides for the current integration workflows:
 ...
 - [C-Play -> NDI output](/system-integration/ndi-output) - Publish the main video or individual presentation layers as NDI sources so other applications (e.g. OBS Studio) can receive C-Play content over the network. New in 2.4.0.
